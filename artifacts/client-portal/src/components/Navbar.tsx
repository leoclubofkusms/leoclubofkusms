        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative">
              ...
              {archiveOpen && (
                <div className="absolute top-8 left-0 bg-white text-[#002147] rounded-lg shadow-xl border border-gray-100 w-48 py-2 z-50">
                  {LEO_YEARS.map((y) => (
      ...
      {open && (
        <div className="md:hidden bg-[#001a38] border-t border-white/10 px-4 py-4 flex flex-col gap-4">
          ...
          <form onSubmit={handleVerify} className="flex gap-2">
            ...
            <button
              type="submit"
              className="bg-[#D4AF37] text-[#002147] px-3 rounded-lg font-semibold text-sm"
            >
              Go
            </button>
          </form>
          {isAdmin ? (
            <div className="flex flex-col gap-2">
              ...
              <button onClick={signOut} className="text-sm text-white/60 text-left">
                Logout
              </button>
            </div>
          ) : (
